...
public class MultiSelectSpinner extends Spinner implements OnMultiChoiceClickListener {
    ...
    /**
     * Builds the string of selected indices.
     * @return comma-separated list of selected indices
     */
    private String buildSelectedIndicesString(String separator) {
        StringBuilder sb = new StringBuilder();
        boolean foundOne = false;
    ...
    /**
     * Returns selected indices joined with separator
     * @param separator
     * @return Join indices
     */
    public String getSelectedIndicesJoined(String separator) {
    	return buildSelectedIndicesString(separator);
    }
    ...
    /**
     * Clears and rebuilds selected items for view
     */
    public void rebuildViewElement() {
        _proxyAdapter.clear();
        _proxyAdapter.add(buildSelectedItemString());
    }
}
